...
check "$ROOT/assets/evorule-rules/scenario-expense-compliance.json" "$STAGE/rules/scenario-expense-compliance.json"
check "$ROOT/assets/evorule-rules/scenario-equipment-inspection.json" "$STAGE/rules/scenario-equipment-inspection.json"
check "$ROOT/assets/evorule-rules/scenario-ai-mfa-gate.json" "$STAGE/rules/scenario-ai-mfa-gate.json"
