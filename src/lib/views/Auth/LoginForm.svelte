...
<section class="login-page">
  <header class="login-header">
    ...
    <!-- UV-156:措辞通俗化,去掉「服务端实时下发/平台管理面/业务功能面」等技术术语 -->
    <p>两种登录方式:<strong>平台账号</strong>由服务端统一管理权限(适合团队/生产环境,可管理用户与角色);<strong>演示模式</strong>可一键体验规则库/执行台/审计等核心功能,无需连接服务器,但不能管理用户与角色,适合首次体验。</p>
  </header>
